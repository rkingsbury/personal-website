...
$$\begin{equation} \mu = \mu^o + RT \ln a \end{equation} \tag{}$$
...
$$\begin{equation} a = m \gamma \end{equation} \tag{}$$
...
$$\begin{equation} \mu\_{NaCl} = \mu\_{NaCl}^o + RT \ln a\_{NaCl}  $\end{equation} \tag{}$$

and substituting equation 2 for $a\_{NaCl}$, we have

$$\begin{equation} \mu\_{NaCl} = \mu\_{NaCl}^o + RT \ln m\_{NaCl} \gamma\_{NaCl} $\end{equation} \tag{}$$
...
$$\begin{equation} NaCl => Na^+ + Cl^- \end{equation} \tag{}$$
...
$$\begin{equation} \mu\_{NaCl} = \mu\_{Na^+} + \mu\_{Cl^-} $\end{equation} \tag{}$$

which also implies that 

$$\begin{equation} \mu\_{NaCl}^o = \mu^o\_{Na^+} + \mu^o\_{Cl^-} $\end{equation} \tag{}$$
...
$$\begin{equation} \mu\_{NaCl} = \mu^o\_{Na^+} + \mu^o\_{Cl-} + RT \ln a\_{Na^+}a\_{Cl^-} $\end{equation} \tag{}$$

$$\begin{equation} \mu\_{NaCl} = \mu^o\_{NaCl} + RT \ln (m\_{Na^+}\gamma\_{Na^+})(m\_{Cl^-}\gamma\_{Cl^-}) $\end{equation} \tag{}$$

which means that

$$\begin{equation} a\_{NaCl} = (m\_{Na^+}\gamma\_{Na^+})(m\_{Cl^-}\gamma\_{Cl^-}) $\end{equation} \tag{}$$
...
$$\begin{equation} a\_\pm = a\_{NaCl}^{\frac{1}{2}} = (m\_{Na^+} m\_{Cl^-} \gamma\_{Na^+}\gamma\_{Cl^-})^{\frac{1}{2}} $\end{equation} \tag{}$$

Correspondingly, the *mean ionic activity coefficient* and *mean ionic molality* are defined as

$$\begin{equation} \gamma\_\pm = (\gamma\_{Na^+} \gamma\_{Cl^-})^{\frac{1}{2}} $\end{equation} \tag{}$$

and

$$\begin{equation} m\_\pm = (m\_{Na^+} m\_{Cl^-})^{\frac{1}{2}} $\end{equation} \tag{}$$
...
$$\begin{equation} \mu\_{NaCl} = \mu^o\_{NaCl} + RT \ln (m\_\pm\gamma\_\pm)^2 $\end{equation} \tag{}$$
...
$$\begin{equation} MgCl_2 => 1 Mg^{+2} + 2 Cl^{-} $\end{equation} \tag{}$$
...
$$\begin{equation} \mu\_{salt} = \nu\_{+} \mu\_{+} + \nu\_{-} \mu\_{-} $\end{equation} \tag{}$$

$$\begin{equation} \mu\_{salt} = \nu\_{+} (\mu^o\_{+} + RT \ln a\_{+}) + \nu\_{-} ( \mu^o\_{-} + RT a\_{-}) $\end{equation} \tag{}$$

$$\begin{equation} \mu\_{salt}^o = \nu\_{+} \mu^o\_{+} + \nu\_{-}\mu^o\_{-} $\end{equation} \tag{}$$
